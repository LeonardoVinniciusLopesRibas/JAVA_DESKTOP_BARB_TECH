...
public class LoginAdministradorDao implements DaoInterfaces{
    ...
    public int getUserId(String usuario, String senhaCriptografada) {
        ...
        sql = "SELECT id FROM usuarioadministrador WHERE usuario = ? AND senha = ?";
        ...
        try{
            ...
            JOptionPane.showMessageDialog(null, "integrador.barbtech.dao.LoginDao.getUserId()" +sex );
        }
        return userId;
    }
